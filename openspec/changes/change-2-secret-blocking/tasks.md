...
- [ ] 2.4 Set defaultAction to `{ type: "block", message: "..." }`
...
- [ ] 3.3 Set defaultAction to `{ type: "block", message: "..." }`
...
- [ ] 4.4 Add matcher for any file in `~/.ssh/` that does NOT end with `.pub` or `.pubkey` and is NOT `known_hosts`, `config`, `authorized_keys`
- [ ] 4.5 Set defaultAction to `{ type: "block", message: "..." }`
...
- [ ] 5.5 Set defaultAction to `{ type: "block", message: "..." }`
...
- [ ] 6.6 Set defaultAction to `{ type: "block", message: "..." }`
